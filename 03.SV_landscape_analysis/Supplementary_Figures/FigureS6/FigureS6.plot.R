...
# 读取数据 - 确保列名匹配
data <- read.delim("HET_HOM.count.addinfo.txt")
...
p1 <- ggplot(data, aes(x = Stage, y = HOM)) +
  ...
  scale_y_continuous(
    limits = c(15000, 27000),
    breaks = c(15000, 18000, 21000, 24000, 27000),
    labels = c("15k", "18k", "21k", "24k", "27k")
  ) + 
...
# 保存图标到原文件目录
ggsave("HOM_Stages_comparison_with_significance.png", p1, width = 6, height = 4, dpi = 300)
ggsave("HOM_Stages_comparison_with_significance.pdf", p1, width = 6, height = 4)
...
# 保存图标到原文件目录
ggsave("HET_Stages_comparison_with_significance.png", p2, width = 6, height = 4, dpi = 300)
ggsave("HET_Stages_comparison_with_significance.pdf", p2, width = 6, height = 4)
...
# 保存图标到原文件目录
ggsave("HOM_Farms_comparison_with_significance.png", p1, width = 6, height = 4, dpi = 300)
ggsave("HOM_Farms_comparison_with_significance.pdf", p1, width = 6, height = 4)
...
# 保存图标到原文件目录
ggsave("HET_Farms_comparison_with_significance.png", p1, width = 6, height = 4, dpi = 300)
ggsave("HET_Farms_comparison_with_significance.pdf", p1, width = 6, height = 4)
...
# 保存图标到原文件目录
ggsave("HOM_Strains_comparison_with_significance.png", p1, width = 6, height = 4, dpi = 300)
ggsave("HOM_Strains_comparison_with_significance.pdf", p1, width = 6, height = 4)
...
# 保存图标到原文件目录
ggsave("HET_Strains_comparison_with_significance.png", p1, width = 6, height = 4, dpi = 300)
ggsave("HET_Strains_comparison_with_significance.pdf", p1, width = 6, height = 4)
...
# 保存图标到原文件目录
ggsave("HOM_Sexs_comparison_with_significance.png", p1, width = 6, height = 4, dpi = 300)
ggsave("HOM_Sexs_comparison_with_significance.pdf", p1, width = 6, height = 4)
...
# 保存图标到原文件目录
ggsave("HET_Sexs_comparison_with_significance.png", p1, width = 6, height = 4, dpi = 300)
ggsave("HET_Sexs_comparison_with_significance.pdf", p1, width = 6, height = 4)




# 读取数据 - 确保列名匹配
data <- read.delim("MAF0.05.HET_HOM.count.addinfo.txt")
...
p9 <- ggplot(data, aes(x = Stage, y = HOM)) +
  ...
  scale_y_continuous(
    ...
    breaks = c(12000, 15000, 18000, 21000, 24000),
    labels = c("12k", "15k", "18k", "21k", "24k")
  ) + 
  scale_fill_manual(values = c("#66C2A5", "#FC8D62", "#8DA0CB", "#E78AC3")) +
  labs(
    title = "MAF0.05_Stage",
...
# 保存图标到原文件目录
ggsave("MAF0.05_HOM_Stages_comparison_with_significance.png", p1, width = 6, height = 4, dpi = 300)
ggsave("MAF0.05_HOM_Stages_comparison_with_significance.pdf", p1, width = 6, height = 4)
...
# 保存图标到原文件目录
ggsave("MAF0.05_HET_Stages_comparison_with_significance.png", p2, width = 6, height = 4, dpi = 300)
ggsave("MAF0.05_HET_Stages_comparison_with_significance.pdf", p2, width = 6, height = 4)
...
# 保存图标到原文件目录
ggsave("MAF0.05_HOM_Farms_comparison_with_significance.png", p1, width = 6, height = 4, dpi = 300)
ggsave("MAF0.05_HOM_Farms_comparison_with_significance.pdf", p1, width = 6, height = 4)
...
# 保存图标到原文件目录
ggsave("MAF0.05_HET_Farms_comparison_with_significance.png", p1, width = 6, height = 4, dpi = 300)
ggsave("MAF0.05_HET_Farms_comparison_with_significance.pdf", p1, width = 6, height = 4)
...
# 保存图标到原文件目录
ggsave("MAF0.05_HOM_Strains_comparison_with_significance.png", p1, width = 6, height = 4, dpi = 300)
ggsave("MAF0.05_HOM_Strains_comparison_with_significance.pdf", p1, width = 6, height = 4)
...
# 保存图标到原文件目录
ggsave("MAF0.05_HET_Strains_comparison_with_significance.png", p1, width = 6, height = 4, dpi = 300)
ggsave("MAF0.05_HET_Strains_comparison_with_significance.pdf", p1, width = 6, height = 4)
...
# 保存图标到原文件目录
ggsave("MAF0.05_HOM_Sexs_comparison_with_significance.png", p1, width = 6, height = 4, dpi = 300)
ggsave("MAF0.05_HOM_Sexs_comparison_with_significance.pdf", p1, width = 6, height = 4)
...
# 保存图标到原文件目录
ggsave("MAF0.05_HET_Sexs_comparison_with_significance.png", p1, width = 6, height = 4, dpi = 300)
ggsave("MAF0.05_HET_Sexs_comparison_with_significance.pdf", p1, width = 6, height = 4)
...
ggsave("FigureS6.png", Fp, width = 24, height = 16, dpi = 300)
ggsave("FigureS6.pdf", Fp, width = 24, height = 16)
